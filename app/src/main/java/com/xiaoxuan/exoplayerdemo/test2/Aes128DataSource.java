...
/**
 * A {@link DataSource} that decrypts data read from an upstream source, encrypted with AES-128 with a 128-bit key and
 * PKCS7 padding.
 *
 * <p>
 * Note that this {@link DataSource} does not support being opened from arbitrary offsets. It is designed specifically
 * for reading whole files as defined in an HLS media playlist. For this reason the implementation is private to the HLS
 * package.
 */
